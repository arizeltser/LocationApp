...
fun LocationDisplay(viewModel: LocationViewModel, locationUtils: LocationUtils, context: Context) {
        ...
        onResult = {permissions ->
            if(permissions[Manifest.permission.ACCESS_COARSE_LOCATION] == true && permissions[Manifest.permission.ACCESS_FINE_LOCATION] == true) {
                ...
                if (rationaleRequired) {
                    ...
                    Toast.makeText(context, "Location permission is required. PLease enable in settings",Toast.LENGTH_LONG).show()
                }
    ...
    Column (modifier = Modifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center){
        ...
        if (location != null) {
            Text(text = "Loc: ${location.latitude}, ${location.longitude}\nAddress: $address")
        }
        else {
